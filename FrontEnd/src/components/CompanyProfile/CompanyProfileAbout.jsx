...
import styles from "./css/CompanyProfileAbout.module.css";
import { FiEdit2 } from "react-icons/fi";
import CompanyProfileAboutEdit from "./Edit/CompanyProfileAboutEdit";

const CompanyProfileAbout = ({user,profileOwner}) => {
  ...
  return (
    <div className={styles.aboutContainer}>
      ...
      {profileOwner && edit && <CompanyProfileAboutEdit isOpen={edit} onClose={handleEdit} userId={user?._id}/>}
    </div>
  );
};
