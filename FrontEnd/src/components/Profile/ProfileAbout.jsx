...
const ProfileAbout = ({profileOwner,isProfileOwner}) => {
  ...
  return (
    <div className={styles.aboutContainer}>
      ...
      <p className={styles.aboutText}>
        {profileOwner?.about || "Add your about information here"}
      </p>
      {isProfileOwner && edit && <ProfileAboutEdit isOpen={edit} onClose={handleEdit} userId={profileOwner?._id}/>}
    </div>
  );
};
