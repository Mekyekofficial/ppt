...
const ProfileCertificate = ({ profileOwner, isProfileOwner }) => {
  const [edit, setEdit] = useState(false);

  const certs = profileOwner?.certification || [
    { name: "", field: "", duration: "" },
    { name: "", field: "", duration: "" },
  ];
    ...
    <div className={styles.educationCard}>
      <div className={styles.header}>
        ...
        {isProfileOwner && (
          <svg
            ...
            <path
              d="M41.6667 158.333H53.5417L135 76.875L123.125 65L41.6667 146.458V158.333ZM25 175V139.583L146.875 18.125L181.667 53.75L60.4167 175H25ZM128.958 71.0417L123.125 65L135 76.875L128.958 71.0417Z"
              fill="black"
            />
          </svg>
        )}
      ...
      <div className={styles.content}>
        <div className={styles.timeline}>
          <div className={styles.item}>
            <svg
              ...
              xmlns="http://www.w3.org/2000/svg">
              <path
                d="M346.647 159.77C346.647 239.54 282.296 304.208 202.916 304.208C123.537 304.208 59.1875 239.54 59.1875 159.77C59.1875 79.9995 123.537 15.3328 202.916 15.3328C282.296 15.3328 346.647 79.9995 346.647 159.77Z"
                stroke="black"
                stroke-width="16"
              ...
              />
              <path
                d="M78.4166 230.617L14.5 341.869L83.5636 323.273L102.069 392.677L157.526 296.15"
                stroke="black"
                stroke-width="16"
                stroke-linecap="round"
                stroke-linejoin="round"
              />
              <path
                d="M327.578 230.617L391.494 341.869L322.431 323.273L303.926 392.677L248.469 296.15"
                stroke="black"
                stroke-width="16"
                stroke-linecap="round"
                stroke-linejoin="round"
            ...
            <div>
              <div className={styles.degree}>
                {certs[0]?.name || "Add your Certification"}
              </div>
        ...
        <div className={styles.passingYear}>
          <div className={styles.year}>
            {certs[0]?.duration || "Add Duration"}
          </div>
          <div className={styles.year}>
            {certs[1]?.duration || "Add Duration"}
          </div>
        </div>
      </div>
      ...
      <div className={styles.showMore}>
        ...
        <svg
          ...
          xmlns="http://www.w3.org/2000/svg">
          <path
            d="M66.2109 94.5835L113.503 141.875L160.794 94.5835"
            stroke="black"
            stroke-width="22.67"
            stroke-linecap="round"
            stroke-linejoin="round"
