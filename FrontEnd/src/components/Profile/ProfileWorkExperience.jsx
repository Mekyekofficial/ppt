...
const ProfileWorkExperience = ({profileOwner, isProfileOwner}) => {
    ...
    <div className={styles.workContainer}>
      ...
      <div className={styles.workContent}>
        <p className={styles.jobTitle}><b>
          {experience[0]?.title || "add your Job Title"} || {experience[0]?.company || "add your Company"}
        </b></p>
        <p className={styles.jobDuration}><b>
          {experience[0]?.startDate || "add your Job Start date"} - {experience[0]?.endDate || "add your Job End date"}
        </b></p>
        <ul className={styles.jobDetails}>
          {experience[0]?.description || "add your Job Description"}
        </ul>
      </div>
      ...
      {edit && <ProfileExperienceEdit isOpen={edit} onClose={handleEdit} userId={profileOwner?._id} />}
    </div>
  );
};
