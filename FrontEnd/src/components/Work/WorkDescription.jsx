  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.tabs}>
        <div className={`${styles.tab} ${styles.activeTab}`}>Job Description</div>
        ...
        <div className={styles.detailsWithLogo}>
            ...
            <div className={styles.details}>
                ...
                <div className={styles.companyName}>
                    ...
                    <path fill-rule="evenodd" clip-rule="evenodd" d="M0 42.8571C0 19.1878 19.1878 0 42.8571 0H214.286C237.955 0 257.143 19.1878 257.143 42.8571V128.334C203.192 146.276 164.286 197.166 164.286 257.143C164.286 290.169 175.895 319.26 190.365 342.857H14.2857C6.39594 342.857 0 336.46 0 328.571V42.8571Z" fill="#8FBFFA"/>
                    <path fill-rule="evenodd" clip-rule="evenodd" d="M96.4252 71.4275C96.4252 61.5652 88.4304 53.5703 78.5681 53.5703C68.7058 53.5703 60.7109 61.5652 60.7109 71.4275V99.9989C60.7109 109.861 68.7058 117.856 78.5681 117.856C88.4304 117.856 96.4252 109.861 96.4252 99.9989V71.4275ZM196.425 71.4275C196.425 61.5652 188.43 53.5703 178.568 53.5703C168.706 53.5703 160.711 61.5652 160.711 71.4275V99.9989C160.711 109.861 168.706 117.856 178.568 117.856C188.43 117.856 196.425 109.861 196.425 99.9989V71.4275ZM78.5681 153.57C88.4304 153.57 96.4252 161.565 96.4252 171.427V199.999C96.4252 209.861 88.4304 217.856 78.5681 217.856C68.7058 217.856 60.7109 209.861 60.7109 199.999V171.427C60.7109 161.565 68.7058 153.57 78.5681 153.57ZM196.328 169.552C195.391 160.571 187.797 153.57 178.568 153.57C168.706 153.57 160.711 161.565 160.711 171.427V199.999C160.711 207.01 164.751 213.077 170.631 215.999C176.105 198.771 184.925 183.035 196.328 169.552ZM146.425 342.856V285.713C146.425 275.851 138.43 267.856 128.568 267.856C118.706 267.856 110.711 275.851 110.711 285.713V342.856H146.425Z" fill="#2859C5"/>
                    <path fill-rule="evenodd" clip-rule="evenodd" d="M292.069 397.592C292.071 397.595 292.074 397.598 300 385.712L292.074 397.598C296.874 400.798 303.126 400.798 307.926 397.598L300 385.712C307.926 397.598 307.929 397.595 307.931 397.592L307.943 397.586L307.966 397.569L308.04 397.521L308.28 397.358L309.111 396.786C309.817 396.298 310.82 395.589 312.077 394.678C314.591 392.852 318.131 390.195 322.354 386.792C330.78 380.003 342.046 370.152 353.354 357.901C375.514 333.895 400 298.349 400 257.141C400 201.912 355.229 157.141 300 157.141C244.771 157.141 200 201.912 200 257.141C200 298.349 224.486 333.895 246.646 357.901C257.954 370.152 269.219 380.003 277.645 386.792C281.869 390.195 285.409 392.852 287.923 394.678C289.18 395.589 290.183 396.298 290.889 396.786L291.72 397.358L291.96 397.521L292.034 397.569L292.057 397.586L292.069 397.592Z" fill="#2859C5"/>
                    <path fill-rule="evenodd" clip-rule="evenodd" d="M271.43 257.142C271.43 241.362 284.222 228.57 300.001 228.57C315.781 228.57 328.573 241.362 328.573 257.142C328.573 272.921 315.781 285.713 300.001 285.713C284.222 285.713 271.43 272.921 271.43 257.142Z" fill="#8FBFFA"/>
                    </g>
                    <defs>
                ...
                <div className={styles.date}>
                    <svg className={styles.icon} viewBox="0 0 400 400" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M57.1462 71.4297C33.4768 71.4297 14.2891 90.6174 14.2891 114.287V342.858C14.2891 366.527 33.4768 385.715 57.1462 385.715H342.861C366.529 385.715 385.718 366.527 385.718 342.858V114.287C385.718 90.6174 366.529 71.4297 342.861 71.4297H57.1462Z" fill="#8FBFFA"/>
      ...
      <div className={styles.infoGrid}>
        <div className={styles.infoItem}>
          <svg className={styles.icon} viewBox="0 0 637 620" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <feBlend mode="normal" in2="BackgroundImageFix" result="effect1_dropShadow_2651_3999"/>
            <feBlend mode="normal" in="SourceGraphic" in2="effect1_dropShadow_2651_3999" result="shape"/>
            </filter>
            </defs>
            </svg>
          Experience
        ...
        <defs>
        <pattern id="pattern0_2651_4012" patternContentUnits="objectBoundingBox" width="1" height="1">
        <use xlink:href="#image0_2651_4012" transform="scale(0.0208333)"/>
        </pattern>
        ...
        <defs>
        <pattern id="pattern0_2651_4017" patternContentUnits="objectBoundingBox" width="1" height="1">
        <use xlink:href="#image0_2651_4017" transform="scale(0.0208333)"/>
        </pattern>
        ...
        <defs>
        <pattern id="pattern0_2651_4028" patternContentUnits="objectBoundingBox" width="1" height="1">
        <use xlink:href="#image0_2651_4028" transform="scale(0.0208333)"/>
        </pattern>
      ...
      <div className={styles.featuredCards}>
        <div className={styles.card}>
            <div className={styles.cardCompanyDetails}>
                <img src={SampleImage} alt="Company Logo" className={styles.cardLogo} />
...
Remote</p>
      ...
      <textarea placeholder="Write a feedback" className={styles.feedbackInput}></textarea>
      ...
      <div className={styles.ratingSection}>
            ...
            <div className={styles.stars}>
                {[...Array(5)].map((_, index) => (
                <svg  key={index} className={styles.star} viewBox="0 0 264 217" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M132 0L162.983 82.5725H263.246L182.131 133.605L213.114 216.178L132 165.145L50.8856 216.178L81.8686 133.605L0.754196 82.5725H101.017L132 0Z" fill="#D9D9D9"/>
</svg>
                ))}
            </div>
        </div>
